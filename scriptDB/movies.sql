...
(3,	'2020_03_10_222840_create_directors_table',	1),
(4,	'2020_03_10_222959_add_director_id_to_movies_table',	1),
(5,	'2020_03_10_223218_add_revenue_to_movies_table',	1),
(6,	'2020_03_10_223306_delete_rating_from_movies_table',	1);
...
CREATE TABLE `movies` (
  ...
  CONSTRAINT `movies_director_id_foreign` FOREIGN KEY (`director_id`) REFERENCES `directors` (`id`),
  CONSTRAINT `movies_genre_id_foreign` FOREIGN KEY (`genre_id`) REFERENCES `genres` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `movies` (`id`, `created_at`, `updated_at`, `title`, `director_id`, `awards`, `revenue`, `release_date`, `length`, `genre_id`) VALUES
(1,	NULL,	NULL,	'Avatar',	NULL,	3,	'',	'2010-10-04 00:00:00',	120,	5),
(2,	NULL,	NULL,	'Titanic',	NULL,	11,	'',	'1997-09-04 00:00:00',	320,	3),
(3,	NULL,	NULL,	'La Guerra de las galaxias: Episodio VI',	NULL,	7,	'',	'2004-07-04 00:00:00',	NULL,	5),
(4,	NULL,	NULL,	'La Guerra de las galaxias: Episodio VII',	NULL,	6,	'',	'2003-11-04 00:00:00',	180,	5),
(5,	NULL,	NULL,	'Parque Jurasico',	NULL,	5,	'',	'1999-01-04 00:00:00',	270,	5),
(6,	NULL,	NULL,	'Harry Potter y las Reliquias de la Muerte - Parte 2',	NULL,	2,	'',	'2008-07-04 00:00:00',	190,	6),
(7,	NULL,	NULL,	'Transformers: el lado oscuro de la luna',	NULL,	1,	'',	'2005-07-04 00:00:00',	NULL,	5),
(8,	NULL,	NULL,	'Harry Potter y la piedra filosofal',	NULL,	1,	'',	'2008-04-04 00:00:00',	120,	8),
(9,	NULL,	NULL,	'Harry Potter y la cámara de los secretos',	NULL,	2,	'',	'2009-08-04 00:00:00',	200,	8),
(10,	NULL,	NULL,	'El rey león',	NULL,	3,	'',	'2000-02-04 00:00:00',	NULL,	10),
(11,	NULL,	NULL,	'Alicia en el país de las maravillas',	NULL,	2,	'',	'2008-07-04 00:00:00',	120,	NULL),
(12,	NULL,	NULL,	'Buscando a Nemo',	NULL,	2,	'',	'2000-07-04 00:00:00',	110,	7),
(13,	NULL,	NULL,	'Toy Story',	NULL,	0,	'',	'2008-03-04 00:00:00',	150,	7),
(14,	NULL,	NULL,	'Toy Story 2',	NULL,	2,	'',	'2003-04-04 00:00:00',	120,	7),
(15,	NULL,	NULL,	'La vida es bella',	NULL,	5,	'',	'1994-10-04 00:00:00',	NULL,	3),
(16,	NULL,	NULL,	'Mi pobre angelito',	NULL,	1,	'',	'1989-01-04 00:00:00',	120,	1),
(17,	NULL,	NULL,	'Intensamente',	NULL,	2,	'',	'2008-07-04 00:00:00',	120,	7),
(18,	NULL,	NULL,	'Carrozas de fuego',	NULL,	7,	'',	'1980-07-04 00:00:00',	180,	NULL),
(19,	NULL,	NULL,	'Big',	NULL,	2,	'',	'1988-02-04 00:00:00',	130,	8),
(20,	NULL,	NULL,	'I am Sam',	NULL,	4,	'',	'1999-03-04 00:00:00',	130,	3),
(21,	NULL,	NULL,	'Hotel Transylvania',	NULL,	1,	'',	'2012-05-04 00:00:00',	90,	10);
...
(1,	'Jacinthe Satterfield',	'jayda.streich@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'YxkyiMperd',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(2,	'Prof. Aiyana Hirthe',	'cjacobs@example.net',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'UeGzBxrRsF',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(3,	'Dr. Kendra Boyle Jr.',	'diamond73@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'qXSuzf3cYc',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(4,	'Noe Rippin',	'ansley.huel@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'N8UA7CvT7v',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(5,	'Adele Predovic',	'lavina.jerde@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'SaSQZp880N',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(6,	'Prof. Arlie Harris',	'jupton@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'gagYqF79wG',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(7,	'Jayce Jast I',	'choeger@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'SVnWstg99H',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(8,	'Prof. Norbert Schmitt PhD',	'rjacobs@example.com',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'9xkpszM5FO',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(9,	'Harvey Kessler',	'harvey.max@example.org',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'44LTcXyYLW',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(10,	'Micah Farrell PhD',	'bethany.kerluke@example.com',	'2020-03-11 02:41:40',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'n0bvwm4xOp',	'2020-03-11 02:41:40',	'2020-03-11 02:41:40'),
(11,	'Otis Pacocha',	'fabiola44@example.com',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'6QXxAoDIKq',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(12,	'Miss Edyth Johnston',	'zgaylord@example.org',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'5cNoztX0HG',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(13,	'Mrs. Lilly Considine Sr.',	'ghodkiewicz@example.net',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'Y8IWYCyCXd',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(14,	'Rubye Murphy',	'sruecker@example.net',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'lkyaSI02WD',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(15,	'Tyshawn Dare',	'alexa.wilkinson@example.org',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'j5pBhzKrCw',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(16,	'Dr. Rudy Mann PhD',	'larson.earnestine@example.org',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'2NpP4V50Ea',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(17,	'Sofia Waters',	'christiansen.alexandrea@example.com',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'CmJTm9XVhB',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(18,	'Dr. Edmund Labadie',	'jakubowski.rashawn@example.org',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'jERsyDMoTR',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(19,	'Emile Runte',	'diana93@example.com',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'jmtjt7GI3m',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25'),
(20,	'Chet Parisian',	'white.chasity@example.com',	'2020-03-11 02:42:25',	'$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi',	'FAua7ekEhA',	'2020-03-11 02:42:25',	'2020-03-11 02:42:25');
